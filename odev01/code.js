...
function myFunction(){
    ...
    deneme++;
    if(resim.getAttribute("src")=="img/kedi.jpg" && deneme<=2 ){
        kazandı.style.visibility="visible"
        resim.onclick=""
        resim1.onclick=""
        resim2.onclick=""
    }
...
function myFunction1(){
    ...
    deneme++
    if(resim1.getAttribute("src")=="img/kedi.jpg" && deneme<=2){
        kazandı.style.visibility="visible"
        resim.onclick=""
        resim1.onclick=""
        resim2.onclick=""
...
function myFunction2(){
    ...
    deneme++
    if(resim2.getAttribute("src")=="img/kedi.jpg"&& deneme<=2 ){
        kazandı.style.visibility="visible"
        resim.onclick=""
        resim1.onclick=""
        resim2.onclick=""
